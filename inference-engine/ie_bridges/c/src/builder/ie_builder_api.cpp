#include "c_api/builder/ie_builder_api.h"
...
int32_t ie_model_set_operand_value(ie_model_t *model, uint32_t index,
...
int32_t ie_model_add_operation(ie_model_t *model, int32_t type, uint32_t inputCount,
...
int32_t ie_compilation_create(ie_model_t* model, ie_compilation_t**compliation) {
    if (model == nullptr) {
        return IE::error_t::BAD_DATA;
    }
...
int32_t ie_compilation_set_preference(ie_compilation_t* compliation, int32_t preference) {
